...
GPU5PV14Impulse0::GPU5PV14Impulse0()
{
...
double GPU5PV14Impulse0::Impulse_Function(double FiringTime)
{
...
ImpulseNodeClass** GPU5PV14Impulse0::CreateImpulseWorkerList(int NumberOfWorkers) {
  ImpulseWorkerListLength = NumberOfWorkers;
  ImpulseWorkerList = new ImpulseNodeClass*[NumberOfWorkers];

  for (int ImpulseWorkerCounter = 0; ImpulseWorkerCounter < NumberOfWorkers; ImpulseWorkerCounter++)
  {
    ImpulseWorkerList[ImpulseWorkerCounter] = new GPU5PV14Impulse0;
  }

  return ImpulseWorkerList;
}

GPU5PV14Impulse1::GPU5PV14Impulse1()
{
  NumberOfModelDependencies = 3;
  TheModelPtr = new BaseModelClass**[NumberOfModelDependencies];
...
double GPU5PV14Impulse1::Impulse_Function(double FiringTime)
{
return 2.0/(nsm * nprocessors);
...
ImpulseNodeClass** GPU5PV14Impulse1::CreateImpulseWorkerList(int NumberOfWorkers) {
  ImpulseWorkerListLength = NumberOfWorkers;
  ImpulseWorkerList = new ImpulseNodeClass*[NumberOfWorkers];

  for (int ImpulseWorkerCounter = 0; ImpulseWorkerCounter < NumberOfWorkers; ImpulseWorkerCounter++)
  {
    ImpulseWorkerList[ImpulseWorkerCounter] = new GPU5PV14Impulse1;
  }

  return ImpulseWorkerList;
}

GPU5PV14Impulse2::GPU5PV14Impulse2()
{
  NumberOfModelDependencies = 3;
  TheModelPtr = new BaseModelClass**[NumberOfModelDependencies];
  TheModelPtr[0] = (BaseModelClass**)(&WARP);
...
double GPU5PV14Impulse2::Impulse_Function(double FiringTime)
{
return 2.0/(nsm * nprocessors);
...
ImpulseNodeClass** GPU5PV14Impulse2::CreateImpulseWorkerList(int NumberOfWorkers) {
  ImpulseWorkerListLength = NumberOfWorkers;
  ImpulseWorkerList = new ImpulseNodeClass*[NumberOfWorkers];

  for (int ImpulseWorkerCounter = 0; ImpulseWorkerCounter < NumberOfWorkers; ImpulseWorkerCounter++)
  {
    ImpulseWorkerList[ImpulseWorkerCounter] = new GPU5PV14Impulse2;
  }

  return ImpulseWorkerList;
}

GPU5PV14Impulse3::GPU5PV14Impulse3()
{
  NumberOfModelDependencies = 3;
  TheModelPtr = new BaseModelClass**[NumberOfModelDependencies];
  TheModelPtr[0] = (BaseModelClass**)(&EXEC_UNIT);
...
ImpulseNodeClass** GPU5PV14Impulse3::CreateImpulseWorkerList(int NumberOfWorkers) {
  ImpulseWorkerListLength = NumberOfWorkers;
  ImpulseWorkerList = new ImpulseNodeClass*[NumberOfWorkers];

  for (int ImpulseWorkerCounter = 0; ImpulseWorkerCounter < NumberOfWorkers; ImpulseWorkerCounter++)
  {
    ImpulseWorkerList[ImpulseWorkerCounter] = new GPU5PV14Impulse3;
  }

  return ImpulseWorkerList;
}

GPU5PV14Impulse4::GPU5PV14Impulse4()
{
  NumberOfModelDependencies = 3;
  TheModelPtr = new BaseModelClass**[NumberOfModelDependencies];
  TheModelPtr[0] = (BaseModelClass**)(&MEMORY);
...
double GPU5PV14Impulse4::Impulse_Function(double FiringTime)
{
return 2.0/(nsm * nprocessors);
...
ImpulseNodeClass** GPU5PV14Impulse4::CreateImpulseWorkerList(int NumberOfWorkers) {
  ImpulseWorkerListLength = NumberOfWorkers;
  ImpulseWorkerList = new ImpulseNodeClass*[NumberOfWorkers];

  for (int ImpulseWorkerCounter = 0; ImpulseWorkerCounter < NumberOfWorkers; ImpulseWorkerCounter++)
  {
    ImpulseWorkerList[ImpulseWorkerCounter] = new GPU5PV14Impulse4;
  }

  return ImpulseWorkerList;
}

GPU5PV14Impulse5::GPU5PV14Impulse5()
{
  NumberOfModelDependencies = 3;
  TheModelPtr = new BaseModelClass**[NumberOfModelDependencies];
  TheModelPtr[0] = (BaseModelClass**)(&WARP);
...
ImpulseNodeClass** GPU5PV14Impulse5::CreateImpulseWorkerList(int NumberOfWorkers) {
  ImpulseWorkerListLength = NumberOfWorkers;
  ImpulseWorkerList = new ImpulseNodeClass*[NumberOfWorkers];

  for (int ImpulseWorkerCounter = 0; ImpulseWorkerCounter < NumberOfWorkers; ImpulseWorkerCounter++)
  {
    ImpulseWorkerList[ImpulseWorkerCounter] = new GPU5PV14Impulse5;
  }

  return ImpulseWorkerList;
}

GPU5PV14Impulse6::GPU5PV14Impulse6()
{
  NumberOfModelDependencies = 3;
  TheModelPtr = new BaseModelClass**[NumberOfModelDependencies];
  TheModelPtr[0] = (BaseModelClass**)(&WARP);
...
ImpulseNodeClass** GPU5PV14Impulse6::CreateImpulseWorkerList(int NumberOfWorkers) {
  ImpulseWorkerListLength = NumberOfWorkers;
  ImpulseWorkerList = new ImpulseNodeClass*[NumberOfWorkers];

  for (int ImpulseWorkerCounter = 0; ImpulseWorkerCounter < NumberOfWorkers; ImpulseWorkerCounter++)
  {
    ImpulseWorkerList[ImpulseWorkerCounter] = new GPU5PV14Impulse6;
  }

  return ImpulseWorkerList;
}

GPU5PV14Impulse7::GPU5PV14Impulse7()
{
  NumberOfModelDependencies = 3;
  TheModelPtr = new BaseModelClass**[NumberOfModelDependencies];
  TheModelPtr[0] = (BaseModelClass**)(&WARP);
...
double GPU5PV14Impulse7::Impulse_Function(double FiringTime)
{
...
ImpulseNodeClass** GPU5PV14Impulse7::CreateImpulseWorkerList(int NumberOfWorkers) {
  ImpulseWorkerListLength = NumberOfWorkers;
  ImpulseWorkerList = new ImpulseNodeClass*[NumberOfWorkers];

  for (int ImpulseWorkerCounter = 0; ImpulseWorkerCounter < NumberOfWorkers; ImpulseWorkerCounter++)
  {
    ImpulseWorkerList[ImpulseWorkerCounter] = new GPU5PV14Impulse7;
  }
...
double GPU5PV16Worker::Reward_Function(void) {
...
void GPU5PV16::CreateWorkerList(void) {
  for(int i = 0; i < NumberOfWorkers; i++)
    WorkerList[i] = new GPU5PV16Worker;
}
