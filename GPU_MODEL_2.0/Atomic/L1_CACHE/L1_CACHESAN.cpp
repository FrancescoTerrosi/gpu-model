...
L1_CACHESAN::L1_CACHESAN(){
  ...
  int AffectArcs[34][2]={ 
    {0,0}, {2,0}, {1,1}, {4,1}, {11,1}, {12,1}, {0,1}, {13,1}, 
    {3,2}, {2,2}, {1,3}, {5,3}, {11,3}, {12,3}, {3,3}, {13,3}, 
    {7,4}, {2,4}, {6,4}, {8,5}, {9,5}, {8,6}, {7,6}, {9,7}, {2,7}, 
    {10,7}, {13,8}, {3,8}, {11,8}, {12,8}, {13,9}, {0,9}, {12,9}, 
    {11,9}
  };
  for(int n=0;n<34;n++) {
...
void L1_CACHESAN::assignPlacesToActivitiesInst(){
  ...
  WRITE_WITH_KO_DATA.WRITE_L1 = (Place*) LocalStateVariables[1];
  WRITE_WITH_KO_DATA.RESULT_KO = (Place*) LocalStateVariables[4];
  WRITE_WITH_KO_DATA.OK_CONTENT = (Place*) LocalStateVariables[11];
  ...
  READ_FROM_case1.READ_L1 = (Place*) LocalStateVariables[8];
  READ_FROM_case1.MEMORY_OK = (Place*) LocalStateVariables[9];
  READ_FROM_case2.READ_L1 = (Place*) LocalStateVariables[8];
  ...
  REPLACE_case1.KO_CONTENT = (Place*) LocalStateVariables[12];
...
L1_CACHESAN::WRITE_WITH_KO_DATAActivity::WRITE_WITH_KO_DATAActivity(){
  ActivityInitialize("WRITE_WITH_KO_DATA",1,Instantaneous , RaceEnabled, 6,2, false);
}

void L1_CACHESAN::WRITE_WITH_KO_DATAActivity::LinkVariables(){
...
bool L1_CACHESAN::WRITE_WITH_KO_DATAActivity::Enabled(){
  OldEnabled=NewEnabled;
  NewEnabled=(((*(WRITE_L1_Mobius_Mark)) >=1)&&((*(RESULT_KO_Mobius_Mark)) >=1));
  return NewEnabled;
}

double L1_CACHESAN::WRITE_WITH_KO_DATAActivity::Weight(){ 
  return 1;
}

bool L1_CACHESAN::WRITE_WITH_KO_DATAActivity::ReactivationPredicate(){ 
  return false;
}

bool L1_CACHESAN::WRITE_WITH_KO_DATAActivity::ReactivationFunction(){ 
  return false;
}

double L1_CACHESAN::WRITE_WITH_KO_DATAActivity::SampleDistribution(){
  return 0;
}

double* L1_CACHESAN::WRITE_WITH_KO_DATAActivity::ReturnDistributionParameters(){
    return NULL;
}

int L1_CACHESAN::WRITE_WITH_KO_DATAActivity::Rank(){
  return 1;
}

BaseActionClass* L1_CACHESAN::WRITE_WITH_KO_DATAActivity::Fire(){
...
L1_CACHESAN::WRITE_WITH_OK_DATAActivity::WRITE_WITH_OK_DATAActivity(){
  ActivityInitialize("WRITE_WITH_OK_DATA",3,Instantaneous , RaceEnabled, 6,2, false);
}

void L1_CACHESAN::WRITE_WITH_OK_DATAActivity::LinkVariables(){
  WRITE_L1->Register(&WRITE_L1_Mobius_Mark);
...
bool L1_CACHESAN::WRITE_WITH_OK_DATAActivity::Enabled(){
  OldEnabled=NewEnabled;
  NewEnabled=(((*(WRITE_L1_Mobius_Mark)) >=1)&&((*(RESULT_OK_Mobius_Mark)) >=1));
  return NewEnabled;
}

double L1_CACHESAN::WRITE_WITH_OK_DATAActivity::Weight(){ 
  return 1;
}

bool L1_CACHESAN::WRITE_WITH_OK_DATAActivity::ReactivationPredicate(){ 
  return false;
}

bool L1_CACHESAN::WRITE_WITH_OK_DATAActivity::ReactivationFunction(){ 
  return false;
}

double L1_CACHESAN::WRITE_WITH_OK_DATAActivity::SampleDistribution(){
  return 0;
}

double* L1_CACHESAN::WRITE_WITH_OK_DATAActivity::ReturnDistributionParameters(){
    return NULL;
}

int L1_CACHESAN::WRITE_WITH_OK_DATAActivity::Rank(){
  return 1;
}

BaseActionClass* L1_CACHESAN::WRITE_WITH_OK_DATAActivity::Fire(){
  (*(WRITE_L1_Mobius_Mark))--;
