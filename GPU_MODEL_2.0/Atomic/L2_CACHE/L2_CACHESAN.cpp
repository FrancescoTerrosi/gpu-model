...
L2_CACHESAN::L2_CACHESAN(){
  ...
  initializeSANModelNow("L2_CACHE", 18, InitialPlaces, 
                        0, InitialROPlaces, 
  ...
  int AffectArcs[51][2]={ 
    {2,0}, {0,0}, {1,0}, {7,1}, {4,1}, {7,2}, {2,2}, {4,3}, {0,3}, 
    {5,3}, {3,4}, {6,4}, {2,4}, {8,4}, {7,4}, {8,5}, {9,5}, {11,6}, 
  ...
  int EnableArcs[15][2]={ 
    {2,0}, {7,1}, {7,2}, {4,3}, {3,4}, {8,5}, {11,6}, {11,7}, 
...
void L2_CACHESAN::assignPlacesToActivitiesInst(){
  ...
  Instantaneous_Activity1.MEMORY_OK = (Place*) LocalStateVariables[4];
  Instantaneous_Activity1.INSTRUCTION_READY = (Place*) LocalStateVariables[0];
  Instantaneous_Activity1.OK_READ = (Place*) LocalStateVariables[5];
  Instantaneous_Activity4.READ_L2 = (Place*) LocalStateVariables[3];
  ...
  Instantaneous_Activity5.WRITE_L2 = (Place*) LocalStateVariables[10];
...
L2_CACHESAN::Instantaneous_Activity4Activity::Instantaneous_Activity4Activity(){
  ActivityInitialize("Instantaneous_Activity4",3,Instantaneous , RaceEnabled, 5,1, false);
}

void L2_CACHESAN::Instantaneous_Activity4Activity::LinkVariables(){
...
bool L2_CACHESAN::Instantaneous_Activity4Activity::Enabled(){
  OldEnabled=NewEnabled;
  NewEnabled=(((*(READ_L2_Mobius_Mark)) >=1));
  return NewEnabled;
}

double L2_CACHESAN::Instantaneous_Activity4Activity::Weight(){ 
  return 1;
}

bool L2_CACHESAN::Instantaneous_Activity4Activity::ReactivationPredicate(){ 
  return false;
}

bool L2_CACHESAN::Instantaneous_Activity4Activity::ReactivationFunction(){ 
  return false;
}

double L2_CACHESAN::Instantaneous_Activity4Activity::SampleDistribution(){
  return 0;
}

double* L2_CACHESAN::Instantaneous_Activity4Activity::ReturnDistributionParameters(){
    return NULL;
}

int L2_CACHESAN::Instantaneous_Activity4Activity::Rank(){
  return 1;
}

BaseActionClass* L2_CACHESAN::Instantaneous_Activity4Activity::Fire(){
  (*(READ_L2_Mobius_Mark))--;
...
L2_CACHESAN::dhnActivity::dhnActivity(){
  ActivityInitialize("dhn",4,Instantaneous , RaceEnabled, 2,1, false);
}

void L2_CACHESAN::dhnActivity::LinkVariables(){
  MEM_FAILURE_COUNT->Register(&MEM_FAILURE_COUNT_Mobius_Mark);
  Place1->Register(&Place1_Mobius_Mark);
}

bool L2_CACHESAN::dhnActivity::Enabled(){
  OldEnabled=NewEnabled;
  NewEnabled=(((*(MEM_FAILURE_COUNT_Mobius_Mark)) >=1));
  return NewEnabled;
}

double L2_CACHESAN::dhnActivity::Weight(){ 
  return 1;
}

bool L2_CACHESAN::dhnActivity::ReactivationPredicate(){ 
  return false;
}

bool L2_CACHESAN::dhnActivity::ReactivationFunction(){ 
  return false;
}

double L2_CACHESAN::dhnActivity::SampleDistribution(){
  return 0;
}

double* L2_CACHESAN::dhnActivity::ReturnDistributionParameters(){
    return NULL;
}

int L2_CACHESAN::dhnActivity::Rank(){
  return 1;
}

BaseActionClass* L2_CACHESAN::dhnActivity::Fire(){
...
L2_CACHESAN::Instantaneous_Activity3Activity_case1::Instantaneous_Activity3Activity_case1(){
  ActivityInitialize("Instantaneous_Activity3_case1",5,Instantaneous , RaceEnabled, 5,1, false);
}

void L2_CACHESAN::Instantaneous_Activity3Activity_case1::LinkVariables(){
...
bool L2_CACHESAN::Instantaneous_Activity3Activity_case1::Enabled(){
  OldEnabled=NewEnabled;
  NewEnabled=(((*(ROUTE_WRITE_Mobius_Mark)) >=1));
  return NewEnabled;
}

double L2_CACHESAN::Instantaneous_Activity3Activity_case1::Weight(){ 
  return 0.5;
}

bool L2_CACHESAN::Instantaneous_Activity3Activity_case1::ReactivationPredicate(){ 
  return false;
}

bool L2_CACHESAN::Instantaneous_Activity3Activity_case1::ReactivationFunction(){ 
  return false;
}

double L2_CACHESAN::Instantaneous_Activity3Activity_case1::SampleDistribution(){
  return 0;
}

double* L2_CACHESAN::Instantaneous_Activity3Activity_case1::ReturnDistributionParameters(){
    return NULL;
}

int L2_CACHESAN::Instantaneous_Activity3Activity_case1::Rank(){
  return 1;
}

BaseActionClass* L2_CACHESAN::Instantaneous_Activity3Activity_case1::Fire(){
...
L2_CACHESAN::Instantaneous_Activity3Activity_case2::Instantaneous_Activity3Activity_case2(){
  ActivityInitialize("Instantaneous_Activity3_case2",5,Instantaneous , RaceEnabled, 5,1, false);
}

void L2_CACHESAN::Instantaneous_Activity3Activity_case2::LinkVariables(){
  ROUTE_WRITE->Register(&ROUTE_WRITE_Mobius_Mark);
  OK_CONTENT->Register(&OK_CONTENT_Mobius_Mark);
  KO_CONTENT->Register(&KO_CONTENT_Mobius_Mark);
...
bool L2_CACHESAN::Instantaneous_Activity3Activity_case2::Enabled(){
  OldEnabled=NewEnabled;
  NewEnabled=(((*(ROUTE_WRITE_Mobius_Mark)) >=1));
  return NewEnabled;
}

double L2_CACHESAN::Instantaneous_Activity3Activity_case2::Weight(){ 
  return 0.5;
}

bool L2_CACHESAN::Instantaneous_Activity3Activity_case2::ReactivationPredicate(){ 
  return false;
}

bool L2_CACHESAN::Instantaneous_Activity3Activity_case2::ReactivationFunction(){ 
  return false;
}

double L2_CACHESAN::Instantaneous_Activity3Activity_case2::SampleDistribution(){
  return 0;
}

double* L2_CACHESAN::Instantaneous_Activity3Activity_case2::ReturnDistributionParameters(){
    return NULL;
}

int L2_CACHESAN::Instantaneous_Activity3Activity_case2::Rank(){
  return 1;
}

BaseActionClass* L2_CACHESAN::Instantaneous_Activity3Activity_case2::Fire(){
  (*(ROUTE_WRITE_Mobius_Mark))--;
  if (OK_CONTENT->Mark() + KO_CONTENT->Mark() < l2_size) {
...
L2_CACHESAN::Instantaneous_Activity5Activity::Instantaneous_Activity5Activity(){
  ActivityInitialize("Instantaneous_Activity5",6,Instantaneous , RaceEnabled, 8,1, false);
}

void L2_CACHESAN::Instantaneous_Activity5Activity::LinkVariables(){
...
bool L2_CACHESAN::Instantaneous_Activity5Activity::Enabled(){
  OldEnabled=NewEnabled;
  NewEnabled=(((*(WRITE_L2_Mobius_Mark)) >=1));
  return NewEnabled;
}

double L2_CACHESAN::Instantaneous_Activity5Activity::Weight(){ 
  return 1;
}

bool L2_CACHESAN::Instantaneous_Activity5Activity::ReactivationPredicate(){ 
  return false;
}

bool L2_CACHESAN::Instantaneous_Activity5Activity::ReactivationFunction(){ 
  return false;
}

double L2_CACHESAN::Instantaneous_Activity5Activity::SampleDistribution(){
  return 0;
}

double* L2_CACHESAN::Instantaneous_Activity5Activity::ReturnDistributionParameters(){
    return NULL;
}

int L2_CACHESAN::Instantaneous_Activity5Activity::Rank(){
  return 1;
}

BaseActionClass* L2_CACHESAN::Instantaneous_Activity5Activity::Fire(){
...
double L2_CACHESAN::REPLACEActivity_case1::Weight(){ 
  return OK_CONTENT->Mark()/l2_size;
}
...
double L2_CACHESAN::REPLACEActivity_case2::Weight(){ 
  return KO_CONTENT->Mark()/l2_size;
}
...
L2_CACHESAN::REPLACE_KOActivity_case1::REPLACE_KOActivity_case1(){
  ActivityInitialize("REPLACE_KO_case1",8,Instantaneous , RaceEnabled, 2,1, false);
}

void L2_CACHESAN::REPLACE_KOActivity_case1::LinkVariables(){
  REPLACE_CONTENT_KO->Register(&REPLACE_CONTENT_KO_Mobius_Mark);
  KO_CONTENT_TEMP->Register(&KO_CONTENT_TEMP_Mobius_Mark);
}

bool L2_CACHESAN::REPLACE_KOActivity_case1::Enabled(){
  OldEnabled=NewEnabled;
  NewEnabled=(((*(REPLACE_CONTENT_KO_Mobius_Mark)) >=1));
  return NewEnabled;
}

double L2_CACHESAN::REPLACE_KOActivity_case1::Weight(){ 
  return 0.5;
}

bool L2_CACHESAN::REPLACE_KOActivity_case1::ReactivationPredicate(){ 
  return false;
}

bool L2_CACHESAN::REPLACE_KOActivity_case1::ReactivationFunction(){ 
  return false;
}

double L2_CACHESAN::REPLACE_KOActivity_case1::SampleDistribution(){
  return 0;
}

double* L2_CACHESAN::REPLACE_KOActivity_case1::ReturnDistributionParameters(){
    return NULL;
}

int L2_CACHESAN::REPLACE_KOActivity_case1::Rank(){
  return 1;
}

BaseActionClass* L2_CACHESAN::REPLACE_KOActivity_case1::Fire(){
...
L2_CACHESAN::REPLACE_KOActivity_case2::REPLACE_KOActivity_case2(){
  ActivityInitialize("REPLACE_KO_case2",8,Instantaneous , RaceEnabled, 4,1, false);
}

void L2_CACHESAN::REPLACE_KOActivity_case2::LinkVariables(){
  REPLACE_CONTENT_KO->Register(&REPLACE_CONTENT_KO_Mobius_Mark);
  KO_CONTENT_TEMP->Register(&KO_CONTENT_TEMP_Mobius_Mark);
  KO_CONTENT->Register(&KO_CONTENT_Mobius_Mark);
  OK_CONTENT->Register(&OK_CONTENT_Mobius_Mark);
...
bool L2_CACHESAN::REPLACE_KOActivity_case2::Enabled(){
  OldEnabled=NewEnabled;
  NewEnabled=(((*(REPLACE_CONTENT_KO_Mobius_Mark)) >=1));
  return NewEnabled;
}

double L2_CACHESAN::REPLACE_KOActivity_case2::Weight(){ 
  return 0.5;
}

bool L2_CACHESAN::REPLACE_KOActivity_case2::ReactivationPredicate(){ 
  return false;
}

bool L2_CACHESAN::REPLACE_KOActivity_case2::ReactivationFunction(){ 
  return false;
}

double L2_CACHESAN::REPLACE_KOActivity_case2::SampleDistribution(){
  return 0;
}

double* L2_CACHESAN::REPLACE_KOActivity_case2::ReturnDistributionParameters(){
    return NULL;
}

int L2_CACHESAN::REPLACE_KOActivity_case2::Rank(){
  return 1;
}

BaseActionClass* L2_CACHESAN::REPLACE_KOActivity_case2::Fire(){
  (*(REPLACE_CONTENT_KO_Mobius_Mark))--;
  KO_CONTENT_TEMP->Mark()++;
KO_CONTENT->Mark()++;
