...
void EXEC_UNITSAN::assignPlacesToActivitiesInst(){
  ...
  Instantaneous_Activity2_case1.REG_KO_CONTENT = (Place*) LocalStateVariables[8];
  Instantaneous_Activity2_case1.REG_OK_CONTENT = (Place*) LocalStateVariables[7];
  ...
  Instantaneous_Activity2_case2.REG_OK_CONTENT = (Place*) LocalStateVariables[7];
  Instantaneous_Activity2_case2.REG_KO_CONTENT = (Place*) LocalStateVariables[8];
}
...
double EXEC_UNITSAN::Instantaneous_Activity2Activity_case1::Weight(){ 
  return REG_KO_CONTENT->Mark()/( REG_OK_CONTENT->Mark() + REG_KO_CONTENT->Mark() );
}
...
double EXEC_UNITSAN::Instantaneous_Activity2Activity_case2::Weight(){ 
  return REG_OK_CONTENT->Mark()/( REG_OK_CONTENT->Mark() + REG_KO_CONTENT->Mark() );
}
