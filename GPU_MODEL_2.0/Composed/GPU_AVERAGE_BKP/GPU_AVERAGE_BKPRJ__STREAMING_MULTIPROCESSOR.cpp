...
char * GPU_AVERAGE_BKPRJ__STREAMING_MULTIPROCESSOR__SharedNames[] = {"INSTRUCTION_READY", "KO_READ", "MEM_OP_COMPLETE", "OK_READ", "READ_L1", "RESULT_KO", "RESULT_OK", "WRITE_L1"};

GPU_AVERAGE_BKPRJ__STREAMING_MULTIPROCESSOR::GPU_AVERAGE_BKPRJ__STREAMING_MULTIPROCESSOR():Join("STREAMING_MULTIPROCESSOR", 2, 8,GPU_AVERAGE_BKPRJ__STREAMING_MULTIPROCESSOR__SharedNames) {
  Join1 = new GPU_AVERAGE_BKPRJ__Join1();
...
GPU_AVERAGE_BKPRJ__STREAMING_MULTIPROCESSOR::~GPU_AVERAGE_BKPRJ__STREAMING_MULTIPROCESSOR() {
  if (!AllChildrenEmpty()) {
