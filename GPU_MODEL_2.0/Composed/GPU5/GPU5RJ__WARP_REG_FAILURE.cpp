...
char * GPU5RJ__WARP_REG_FAILURE__SharedNames[] = {"FAILURE_INST", "FLOAT_ALU_FAILURE", "INSTRUCTION_READY", "INT_ALU_FAILURE", "KO_CONTENT", "MEM_FAILURE", "OK_CONTENT", "REGISTERS_FILL", "REG_FAILURE", "RESULT_KO", "RESULT_OK", "SCHEDULER", "WARP_ACCESS_DRAM", "WARP_ACCESS_L1", "WARP_ACCESS_L2"};

GPU5RJ__WARP_REG_FAILURE::GPU5RJ__WARP_REG_FAILURE():Join("WARP_REG_FAILURE", 2, 15,GPU5RJ__WARP_REG_FAILURE__SharedNames) {
...
GPU5RJ__WARP_REG_FAILURE::~GPU5RJ__WARP_REG_FAILURE() {
  if (!AllChildrenEmpty()) {
    delete FAILURE_INST;
