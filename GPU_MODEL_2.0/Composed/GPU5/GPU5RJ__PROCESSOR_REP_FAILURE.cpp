...
char * GPU5RJ__PROCESSOR_REP_FAILURE__SharedNames[] = {"INSTRUCTION_READY", "MEM_FAILURE", "READ_DRAM", "READ_L1", "READ_L2", "WARP_ACCESS_DRAM", "WARP_ACCESS_L1", "WARP_ACCESS_L2", "WRITE_DRAM", "WRITE_L1", "WRITE_L2"};

GPU5RJ__PROCESSOR_REP_FAILURE::GPU5RJ__PROCESSOR_REP_FAILURE():Rep("PROCESSOR_REP_FAILURE", nfailedprocessors, 11, GPU5RJ__PROCESSOR_REP_FAILURE__SharedNames)
{
  InstanceArray = new GPU5RJ__PROCESSOR_FAILURE * [NumModels];
  delete[] ModelArray;
  ModelArray = (BaseModelClass **) InstanceArray;
  for (counter = 0; counter < NumModels; counter++)
    InstanceArray[counter] = new GPU5RJ__PROCESSOR_FAILURE();
...
GPU5RJ__PROCESSOR_REP_FAILURE::~GPU5RJ__PROCESSOR_REP_FAILURE() {
  if (NumModels == 0) return;
