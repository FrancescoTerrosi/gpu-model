...
char * GPU5RJ__SharedNames[] = {"KO_READ", "MEM_OP_COMPLETE", "OK_READ", "READ_DRAM", "READ_L2", "RESULT_KO", "RESULT_OK", "WRITE_DRAM", "WRITE_L2"};

GPU5RJ::GPU5RJ():Join("DEVICE", 3, 9,GPU5RJ__SharedNames) {
