...
char * GPU5RJ__PROCESSOR_REP__SharedNames[] = {"INSTRUCTION_READY", "MEM_FAILURE", "READ_DRAM", "READ_L1", "READ_L2", "WARP_ACCESS_DRAM", "WARP_ACCESS_L1", "WARP_ACCESS_L2", "WRITE_DRAM", "WRITE_L1", "WRITE_L2"};
