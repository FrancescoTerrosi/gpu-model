...
char * GPU_AVERAGERJ__Join1__SharedNames[] = {"INSTRUCTION_READY", "KO_READ", "MEM_OP_COMPLETE", "OK_READ", "READ_DRAM", "READ_GLOBAL_MEMORY", "READ_L1", "READ_L2", "READ_LOCAL_MEMORY", "READ_REGISTER_FILE", "RESULT_KO", "RESULT_OK", "SCHEDULER", "WRITE_DRAM", "WRITE_GLOBAL_MEMORY", "WRITE_L1", "WRITE_L2", "WRITE_LOCAL_MEMORY", "WRITE_REGISTER_FILE"};

GPU_AVERAGERJ__Join1::GPU_AVERAGERJ__Join1():Join("Join1", 5, 19,GPU_AVERAGERJ__Join1__SharedNames) {
...
GPU_AVERAGERJ__Join1::~GPU_AVERAGERJ__Join1() {
  if (!AllChildrenEmpty()) {
