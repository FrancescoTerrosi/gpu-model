...
char * GPU_AVERAGERJ__SharedNames[] = {"INSTRUCTION_READY", "KO_CONTENT", "KO_READ", "MEMORY_KO", "MEMORY_OK", "MEM_OP_COMPLETE", "OK_CONTENT", "OK_READ", "RESULT_KO", "RESULT_OK"};

GPU_AVERAGERJ::GPU_AVERAGERJ():Join("GPU", 3, 10,GPU_AVERAGERJ__SharedNames) {
  STREAMING_MULTIPROCESSOR = new GPU_AVERAGERJ__STREAMING_MULTIPROCESSOR();
