...
char * GPU_FAILURERJ__PROCESSOR__SharedNames[] = {"FLOAT_ALU_FAILURE", "INSTRUCTION_READY", "INT_ALU_FAILURE", "KO_CONTENT", "MEM_FAILURE", "MEM_OP_COMPLETE", "OK_CONTENT", "READ", "READ_DRAM", "READ_L1", "READ_L2", "REGISTERS_FILL", "RESULT_KO", "RESULT_OK", "SCHEDULER", "WARP_ACCESS_DRAM", "WARP_ACCESS_L1", "WARP_ACCESS_L2", "WRITE", "WRITE_DRAM", "WRITE_L1", "WRITE_L2"};

GPU_FAILURERJ__PROCESSOR::GPU_FAILURERJ__PROCESSOR():Join("PROCESSOR", 3, 22,GPU_FAILURERJ__PROCESSOR__SharedNames) {
  Rep1 = new GPU_FAILURERJ__Rep1();
...
GPU_FAILURERJ__PROCESSOR::~GPU_FAILURERJ__PROCESSOR() {
  if (!AllChildrenEmpty()) {
