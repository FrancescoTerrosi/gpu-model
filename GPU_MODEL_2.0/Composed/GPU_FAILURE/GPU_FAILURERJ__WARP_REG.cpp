...
char * GPU_FAILURERJ__WARP_REG__SharedNames[] = {"FLOAT_ALU_FAILURE", "INSTRUCTION_READY", "INST_COUNTER", "INT_ALU_FAILURE", "KO_CONTENT", "MEM_FAILURE", "OK_CONTENT", "REGISTERS_FILL", "REG_FAILURE", "RESULT_KO", "RESULT_OK", "SCHEDULER", "WARP_ACCESS_DRAM", "WARP_ACCESS_L1", "WARP_ACCESS_L2"};

GPU_FAILURERJ__WARP_REG::GPU_FAILURERJ__WARP_REG():Join("WARP_REG", 2, 15,GPU_FAILURERJ__WARP_REG__SharedNames) {
...
GPU_FAILURERJ__WARP_REG::~GPU_FAILURERJ__WARP_REG() {
  if (!AllChildrenEmpty()) {
