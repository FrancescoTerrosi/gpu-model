...
char * GPU_FAILURERJ__STREAMING_MULTIPROCESSOR_FAILURE__SharedNames[] = {"INSTRUCTION_READY", "MEM_FAILURE", "READ_DRAM", "READ_L1", "READ_L2", "WRITE_DRAM", "WRITE_L1", "WRITE_L2"};

GPU_FAILURERJ__STREAMING_MULTIPROCESSOR_FAILURE::GPU_FAILURERJ__STREAMING_MULTIPROCESSOR_FAILURE():Join("STREAMING_MULTIPROCESSOR_FAILURE", 2, 8,GPU_FAILURERJ__STREAMING_MULTIPROCESSOR_FAILURE__SharedNames) {
  PROCESSOR_REP_FAILURE = new GPU_FAILURERJ__PROCESSOR_REP_FAILURE();
  ModelArray[0] = (BaseModelClass*) PROCESSOR_REP_FAILURE;
  ModelArray[0]->DefineName("PROCESSOR_REP_FAILURE");
  L1_CACHE_FAILURE = new L1_CACHESAN();
  ModelArray[1] = (BaseModelClass*) L1_CACHE_FAILURE;
  ModelArray[1]->DefineName("L1_CACHE_FAILURE");
...
GPU_FAILURERJ__STREAMING_MULTIPROCESSOR_FAILURE::~GPU_FAILURERJ__STREAMING_MULTIPROCESSOR_FAILURE() {
  if (!AllChildrenEmpty()) {
