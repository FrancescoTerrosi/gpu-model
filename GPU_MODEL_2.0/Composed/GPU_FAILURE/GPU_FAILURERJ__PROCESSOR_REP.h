#ifndef GPU_FAILURERJ__PROCESSOR_REP_H_
#define GPU_FAILURERJ__PROCESSOR_REP_H_
#include <math.h>
...
class GPU_FAILURERJ__PROCESSOR_REP: public Rep {
 public:
  GPU_FAILURERJ__PROCESSOR ** InstanceArray;

  GPU_FAILURERJ__PROCESSOR_REP();
  ~GPU_FAILURERJ__PROCESSOR_REP();
