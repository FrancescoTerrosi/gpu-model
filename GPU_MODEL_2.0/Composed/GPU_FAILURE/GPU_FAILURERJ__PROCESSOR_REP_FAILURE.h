#ifndef GPU_FAILURERJ__PROCESSOR_REP_FAILURE_H_
#define GPU_FAILURERJ__PROCESSOR_REP_FAILURE_H_
#include <math.h>
...
class GPU_FAILURERJ__PROCESSOR_REP_FAILURE: public Rep {
 public:
  GPU_FAILURERJ__PROCESSOR_FAILURE ** InstanceArray;

  GPU_FAILURERJ__PROCESSOR_REP_FAILURE();
  ~GPU_FAILURERJ__PROCESSOR_REP_FAILURE();
