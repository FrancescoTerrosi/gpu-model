...
char * GPU_FAILURERJ__STREAMING_MULTIPROCESSOR__SharedNames[] = {"INSTRUCTION_READY", "MEM_FAILURE", "READ_DRAM", "READ_L1", "READ_L2", "WRITE_DRAM", "WRITE_L1", "WRITE_L2"};

GPU_FAILURERJ__STREAMING_MULTIPROCESSOR::GPU_FAILURERJ__STREAMING_MULTIPROCESSOR():Join("STREAMING_MULTIPROCESSOR", 2, 8,GPU_FAILURERJ__STREAMING_MULTIPROCESSOR__SharedNames) {
  PROCESSOR_REP = new GPU_FAILURERJ__PROCESSOR_REP();
...
GPU_FAILURERJ__STREAMING_MULTIPROCESSOR::~GPU_FAILURERJ__STREAMING_MULTIPROCESSOR() {
  if (!AllChildrenEmpty()) {
