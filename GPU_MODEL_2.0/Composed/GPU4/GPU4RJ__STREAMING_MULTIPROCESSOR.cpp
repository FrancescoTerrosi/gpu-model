...
char * GPU4RJ__STREAMING_MULTIPROCESSOR__SharedNames[] = {"KO_READ", "MEM_OP_COMPLETE", "OK_READ", "READ_DRAM", "READ_L1", "READ_L2", "RESULT_KO", "RESULT_OK", "WRITE_DRAM", "WRITE_L1", "WRITE_L2"};

GPU4RJ__STREAMING_MULTIPROCESSOR::GPU4RJ__STREAMING_MULTIPROCESSOR():Join("STREAMING_MULTIPROCESSOR", 2, 11,GPU4RJ__STREAMING_MULTIPROCESSOR__SharedNames) {
  PROCESSOR_REP = new GPU4RJ__PROCESSOR_REP();
...
GPU4RJ__STREAMING_MULTIPROCESSOR::~GPU4RJ__STREAMING_MULTIPROCESSOR() {
  if (!AllChildrenEmpty()) {
    delete KO_READ;
