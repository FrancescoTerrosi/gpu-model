#include "Composed/GPU4.BKP/GPU4.BKPRJ.h"
char * GPU4.BKPRJ__SharedNames[] = {"KO_READ", "MEM_OP_COMPLETE", "OK_READ", "READ_DRAM", "READ_L2", "RESULT_KO", "RESULT_OK", "WRITE_DRAM", "WRITE_L2"};

GPU4.BKPRJ::GPU4.BKPRJ():Join("DEVICE", 3, 9,GPU4.BKPRJ__SharedNames) {
  STREAMING_MULTIPROCESSOR = new GPU4.BKPRJ__STREAMING_MULTIPROCESSOR();
