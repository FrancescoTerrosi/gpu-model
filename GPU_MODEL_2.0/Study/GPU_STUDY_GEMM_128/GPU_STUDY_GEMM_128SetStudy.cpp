...
#include "Study/GPU_STUDY_GEMM_128/GPU_STUDY_GEMM_128SetStudy.h"
...
//********************************************************
//GPU_STUDY_GEMM_128SetStudy Constructor
//********************************************************
GPU_STUDY_GEMM_128SetStudy::GPU_STUDY_GEMM_128SetStudy() {
...
//******************************************************
//GPU_STUDY_GEMM_128SetStudy Destructor
//******************************************************
GPU_STUDY_GEMM_128SetStudy::~GPU_STUDY_GEMM_128SetStudy() {
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_dram_size() {
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_failure_index() {
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_global_read_dram() {
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_global_read_l1() {
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_global_read_l2() {
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_global_write_dram() {
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_l1_size() {
  l1_sizeValues[0] = 100;
}
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_l2_size() {
  l2_sizeValues[0] = 100;
}
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_local_read_dram() {
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_local_read_l1() {
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_local_read_l2() {
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_local_write_dram() {
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_local_write_l1() {
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_local_write_l2() {
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_nfailedprocessors() {
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_nfailedsm() {
  nfailedsmValues[0] = 0;
}
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_nfailedwarps() {
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_nprocessors() {
...
// set values for nsm
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_nsm() {
  nsmValues[0] = 1;
}
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_register_count_index() {
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_sim_end() {
  sim_endValues[0] = 100;
}
...
// set values for size
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetValues_size() {
  sizeValues[0] = 896;
}
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::PrintGlobalValues(int expNum) {
  if (NumGVs == 0) {
...
//******************************************************
void *GPU_STUDY_GEMM_128SetStudy::GetGVValue(char *TheGVName) {
  if (strcmp("dram_size", TheGVName) == 0)
    ...
    cerr<<"!! GPU_STUDY_GEMM_128SetStudy::GetGVValue: Global Variable "<<TheGVName<<" does not exist."<<endl;
  return NULL;
}
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::OverrideGVValue(char *TheGVName,void *TheGVValue) {
  if (strcmp("dram_size", TheGVName) == 0)
    ...
    cerr<<"!! GPU_STUDY_GEMM_128SetStudy::OverrideGVValue: Global Variable "<<TheGVName<<" does not exist."<<endl;
}
...
//******************************************************
void GPU_STUDY_GEMM_128SetStudy::SetGVs(int expNum) {
...
BaseStudyClass * GenerateStudy() {
  if (GlobalStudyPtr == NULL)
    GlobalStudyPtr = new GPU_STUDY_GEMM_128SetStudy();
...
//******************************************************
PVModel* GPU_STUDY_GEMM_128SetStudy::GetPVModel(bool expandTimeArrays) {
  if (ThePVModel!=NULL)
    delete ThePVModel;
  // create the PV model
