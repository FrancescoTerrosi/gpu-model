...
#ifndef GPU_STUDY_GEMM_128SetSTUDY_H_
#define GPU_STUDY_GEMM_128SetSTUDY_H_
...
class GPU_STUDY_GEMM_128SetStudy : public BaseStudyClass {
public:

GPU_STUDY_GEMM_128SetStudy();
~GPU_STUDY_GEMM_128SetStudy();
