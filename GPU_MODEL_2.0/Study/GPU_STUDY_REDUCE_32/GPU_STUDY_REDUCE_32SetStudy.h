...
#ifndef GPU_STUDY_REDUCE_32SetSTUDY_H_
#define GPU_STUDY_REDUCE_32SetSTUDY_H_
...
class GPU_STUDY_REDUCE_32SetStudy : public BaseStudyClass {
public:

GPU_STUDY_REDUCE_32SetStudy();
~GPU_STUDY_REDUCE_32SetStudy();
