...
#ifndef GPU_STUDY_GEMM_256SetSTUDY_H_
#define GPU_STUDY_GEMM_256SetSTUDY_H_
...
class GPU_STUDY_GEMM_256SetStudy : public BaseStudyClass {
public:

GPU_STUDY_GEMM_256SetStudy();
~GPU_STUDY_GEMM_256SetStudy();
