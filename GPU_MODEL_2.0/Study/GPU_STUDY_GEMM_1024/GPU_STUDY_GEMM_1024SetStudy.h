...
#ifndef GPU_STUDY_GEMM_1024SetSTUDY_H_
#define GPU_STUDY_GEMM_1024SetSTUDY_H_
...
class GPU_STUDY_GEMM_1024SetStudy : public BaseStudyClass {
public:

GPU_STUDY_GEMM_1024SetStudy();
~GPU_STUDY_GEMM_1024SetStudy();
