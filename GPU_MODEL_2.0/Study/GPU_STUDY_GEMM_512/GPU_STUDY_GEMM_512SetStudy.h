...
#ifndef GPU_STUDY_GEMM_512SetSTUDY_H_
#define GPU_STUDY_GEMM_512SetSTUDY_H_
...
class GPU_STUDY_GEMM_512SetStudy : public BaseStudyClass {
public:

GPU_STUDY_GEMM_512SetStudy();
~GPU_STUDY_GEMM_512SetStudy();
