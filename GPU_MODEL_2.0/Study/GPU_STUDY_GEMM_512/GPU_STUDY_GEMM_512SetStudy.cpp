...
#include "Study/GPU_STUDY_GEMM_512/GPU_STUDY_GEMM_512SetStudy.h"
...
//********************************************************
//GPU_STUDY_GEMM_512SetStudy Constructor
//********************************************************
GPU_STUDY_GEMM_512SetStudy::GPU_STUDY_GEMM_512SetStudy() {
...
//******************************************************
//GPU_STUDY_GEMM_512SetStudy Destructor
//******************************************************
GPU_STUDY_GEMM_512SetStudy::~GPU_STUDY_GEMM_512SetStudy() {
...
//******************************************************
void GPU_STUDY_GEMM_512SetStudy::SetValues_dram_size() {
...
//******************************************************
void GPU_STUDY_GEMM_512SetStudy::SetValues_failure_index() {
...
//******************************************************
void GPU_STUDY_GEMM_512SetStudy::SetValues_l1_size() {
  l1_sizeValues[0] = 100;
}
...
//******************************************************
void GPU_STUDY_GEMM_512SetStudy::SetValues_l2_size() {
  l2_sizeValues[0] = 100;
}
...
//******************************************************
void GPU_STUDY_GEMM_512SetStudy::SetValues_local_read_l2() {
...
//******************************************************
void GPU_STUDY_GEMM_512SetStudy::SetValues_local_write_dram() {
...
//******************************************************
void GPU_STUDY_GEMM_512SetStudy::SetValues_local_write_l2() {
...
//******************************************************
void GPU_STUDY_GEMM_512SetStudy::SetValues_nfailedprocessors() {
...
//******************************************************
void GPU_STUDY_GEMM_512SetStudy::SetValues_nfailedsm() {
  nfailedsmValues[0] = 0;
}
...
//******************************************************
void GPU_STUDY_GEMM_512SetStudy::SetValues_nfailedwarps() {
...
//******************************************************
void GPU_STUDY_GEMM_512SetStudy::SetValues_nprocessors() {
...
// set values for nsm
//******************************************************
void GPU_STUDY_GEMM_512SetStudy::SetValues_nsm() {
  nsmValues[0] = 1;
}
...
//******************************************************
void GPU_STUDY_GEMM_512SetStudy::SetValues_register_count_index() {
...
//******************************************************
void GPU_STUDY_GEMM_512SetStudy::SetValues_sim_end() {
  sim_endValues[0] = 100;
}
...
// set values for size
//******************************************************
void GPU_STUDY_GEMM_512SetStudy::SetValues_size() {
  sizeValues[0] = 3584;
}
...
//******************************************************
void GPU_STUDY_GEMM_512SetStudy::PrintGlobalValues(int expNum) {
  if (NumGVs == 0) {
...
//******************************************************
void *GPU_STUDY_GEMM_512SetStudy::GetGVValue(char *TheGVName) {
  if (strcmp("dram_size", TheGVName) == 0)
    ...
    cerr<<"!! GPU_STUDY_GEMM_512SetStudy::GetGVValue: Global Variable "<<TheGVName<<" does not exist."<<endl;
  return NULL;
}
...
//******************************************************
void GPU_STUDY_GEMM_512SetStudy::OverrideGVValue(char *TheGVName,void *TheGVValue) {
  if (strcmp("dram_size", TheGVName) == 0)
    ...
    cerr<<"!! GPU_STUDY_GEMM_512SetStudy::OverrideGVValue: Global Variable "<<TheGVName<<" does not exist."<<endl;
}
...
//******************************************************
void GPU_STUDY_GEMM_512SetStudy::SetGVs(int expNum) {
...
BaseStudyClass * GenerateStudy() {
  if (GlobalStudyPtr == NULL)
    GlobalStudyPtr = new GPU_STUDY_GEMM_512SetStudy();
...
//******************************************************
PVModel* GPU_STUDY_GEMM_512SetStudy::GetPVModel(bool expandTimeArrays) {
  if (ThePVModel!=NULL)
    delete ThePVModel;
  // create the PV model
