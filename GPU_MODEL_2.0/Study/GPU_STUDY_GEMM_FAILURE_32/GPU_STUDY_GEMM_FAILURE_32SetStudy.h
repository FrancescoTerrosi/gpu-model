...
#ifndef GPU_STUDY_GEMM_FAILURE_32SetSTUDY_H_
#define GPU_STUDY_GEMM_FAILURE_32SetSTUDY_H_

#include "Reward/GPU_FAILURE/GPU_FAILUREPVNodes.h"
#include "Reward/GPU_FAILURE/GPU_FAILUREPVModel.h"
...
class GPU_STUDY_GEMM_FAILURE_32SetStudy : public BaseStudyClass {
public:

GPU_STUDY_GEMM_FAILURE_32SetStudy();
~GPU_STUDY_GEMM_FAILURE_32SetStudy();
