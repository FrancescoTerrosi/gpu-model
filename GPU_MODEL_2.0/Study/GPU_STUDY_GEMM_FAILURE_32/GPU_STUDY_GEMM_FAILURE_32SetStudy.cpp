...
#include "Study/GPU_STUDY_GEMM_FAILURE_32/GPU_STUDY_GEMM_FAILURE_32SetStudy.h"
...
//********************************************************
//GPU_STUDY_GEMM_FAILURE_32SetStudy Constructor
//********************************************************
GPU_STUDY_GEMM_FAILURE_32SetStudy::GPU_STUDY_GEMM_FAILURE_32SetStudy() {
...
//******************************************************
//GPU_STUDY_GEMM_FAILURE_32SetStudy Destructor
//******************************************************
GPU_STUDY_GEMM_FAILURE_32SetStudy::~GPU_STUDY_GEMM_FAILURE_32SetStudy() {
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_dram_size() {
...
// set values for end
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_end() {
  endValues[0] = 100;
}
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_failure_index() {
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_global_read_dram() {
  global_read_dramValues[0] = 0.05;
}
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_global_read_l1() {
  global_read_l1Values[0] = 0.92;
}
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_global_read_l2() {
  global_read_l2Values[0] = 0.03;
}
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_global_write_dram() {
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_global_write_l1() {
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_global_write_l2() {
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_l1_size() {
  l1_sizeValues[0] = 100;
}
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_l2_size() {
  l2_sizeValues[0] = 100;
}
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_local_read_dram() {
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_local_read_l1() {
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_local_read_l2() {
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_local_write_dram() {
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_local_write_l1() {
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_local_write_l2() {
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_nfailedprocessors() {
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_nfailedsm() {
  nfailedsmValues[0] = 1;
}
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_nfailedwarps() {
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_nprocessors() {
...
// set values for nsm
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_nsm() {
  nsmValues[0] = 1;
}
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_nwarps() {
  nwarpsValues[0] = 1;
}
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_register_count_index() {
...
// set values for size
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetValues_size() {
  sizeValues[0] = 224;
}
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::PrintGlobalValues(int expNum) {
  if (NumGVs == 0) {
...
//******************************************************
void *GPU_STUDY_GEMM_FAILURE_32SetStudy::GetGVValue(char *TheGVName) {
  if (strcmp("dram_size", TheGVName) == 0)
    ...
    cerr<<"!! GPU_STUDY_GEMM_FAILURE_32SetStudy::GetGVValue: Global Variable "<<TheGVName<<" does not exist."<<endl;
  return NULL;
}
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::OverrideGVValue(char *TheGVName,void *TheGVValue) {
  if (strcmp("dram_size", TheGVName) == 0)
    ...
    cerr<<"!! GPU_STUDY_GEMM_FAILURE_32SetStudy::OverrideGVValue: Global Variable "<<TheGVName<<" does not exist."<<endl;
}
...
//******************************************************
void GPU_STUDY_GEMM_FAILURE_32SetStudy::SetGVs(int expNum) {
...
BaseStudyClass * GenerateStudy() {
  if (GlobalStudyPtr == NULL)
    GlobalStudyPtr = new GPU_STUDY_GEMM_FAILURE_32SetStudy();
...
//******************************************************
PVModel* GPU_STUDY_GEMM_FAILURE_32SetStudy::GetPVModel(bool expandTimeArrays) {
  if (ThePVModel!=NULL)
    delete ThePVModel;
  // create the PV model
  ThePVModel=new GPU_FAILUREPVModel(expandTimeArrays);
  return ThePVModel;
}
