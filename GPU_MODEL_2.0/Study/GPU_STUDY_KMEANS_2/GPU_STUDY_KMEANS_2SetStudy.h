...
#ifndef GPU_STUDY_KMEANS_2SetSTUDY_H_
#define GPU_STUDY_KMEANS_2SetSTUDY_H_
...
class GPU_STUDY_KMEANS_2SetStudy : public BaseStudyClass {
public:

GPU_STUDY_KMEANS_2SetStudy();
~GPU_STUDY_KMEANS_2SetStudy();
