...
#include "Study/GPU_STUDY_KMEANS_2/GPU_STUDY_KMEANS_2SetStudy.h"
...
//********************************************************
//GPU_STUDY_KMEANS_2SetStudy Constructor
//********************************************************
...
//******************************************************
//GPU_STUDY_KMEANS_2SetStudy Destructor
//******************************************************
GPU_STUDY_KMEANS_2SetStudy::~GPU_STUDY_KMEANS_2SetStudy() {
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_failure_index() {
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_global_read_dram() {
  global_read_dramValues[0] = 0.45;
}
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_global_read_l1() {
  global_read_l1Values[0] = 0.5;
}
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_global_read_l2() {
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_global_write_dram() {
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_global_write_l1() {
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_global_write_l2() {
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_l1_size() {
  l1_sizeValues[0] = 100;
}
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_l2_size() {
  l2_sizeValues[0] = 100;
}
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_local_read_dram() {
  local_read_dramValues[0] = 0.47;
}
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_local_read_l1() {
  local_read_l1Values[0] = 0.5;
}
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_local_read_l2() {
  local_read_l2Values[0] = 0.03;
}
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_local_write_dram() {
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_local_write_l1() {
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_local_write_l2() {
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_nfailedprocessors() {
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_nfailedsm() {
  nfailedsmValues[0] = 0;
}
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_nfailedwarps() {
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_nprocessors() {
...
// set values for nsm
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_nsm() {
  nsmValues[0] = 1;
}
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::SetValues_register_count_index() {
...
//******************************************************
void GPU_STUDY_KMEANS_2SetStudy::PrintGlobalValues(int expNum) {
  if (NumGVs == 0) {
...
void *GPU_STUDY_KMEANS_2SetStudy::GetGVValue(char *TheGVName) {
  if (strcmp("dram_size", TheGVName) == 0)
    ...
    cerr<<"!! GPU_STUDY_KMEANS_2SetStudy::GetGVValue: Global Variable "<<TheGVName<<" does not exist."<<endl;
  return NULL;
}
...
void GPU_STUDY_KMEANS_2SetStudy::OverrideGVValue(char *TheGVName,void *TheGVValue) {
  if (strcmp("dram_size", TheGVName) == 0)
    ...
    cerr<<"!! GPU_STUDY_KMEANS_2SetStudy::OverrideGVValue: Global Variable "<<TheGVName<<" does not exist."<<endl;
}
...
BaseStudyClass * GenerateStudy() {
  if (GlobalStudyPtr == NULL)
    GlobalStudyPtr = new GPU_STUDY_KMEANS_2SetStudy();
...
//******************************************************
PVModel* GPU_STUDY_KMEANS_2SetStudy::GetPVModel(bool expandTimeArrays) {
  if (ThePVModel!=NULL)
    delete ThePVModel;
  // create the PV model
