...
L1_CACHESAN::L1_CACHESAN(){
  ...
  int AffectArcs[20][2]={ 
    {0,0}, {1,0}, {2,1}, {1,1}, {7,2}, {3,2}, {2,2}, {3,3}, {6,3}, 
    {0,3}, {5,4}, {1,4}, {4,4}, {8,5}, {9,5}, {8,6}, {5,6}, {9,7}, 
    {1,7}, {10,7}
  };
  for(int n=0;n<20;n++) {
  ...
  int EnableArcs[10][2]={ 
    {0,0}, {2,1}, {7,2}, {3,2}, {3,3}, {6,3}, {5,4}, {8,5}, {8,6}, 
    {9,7}
  };
  for(int n=0;n<10;n++) {
...
void L1_CACHESAN::assignPlacesToActivitiesInst(){
  ...
  WRITE_WITH_OK_DATA.RESULT_OK = (Place*) LocalStateVariables[7];
  WRITE_WITH_OK_DATA.WRITE_L1 = (Place*) LocalStateVariables[3];
  WRITE_WITH_OK_DATA.OK_CONTENT = (Place*) LocalStateVariables[2];
  WRITE_WITH_KO_DATA.WRITE_L1 = (Place*) LocalStateVariables[3];
...
bool L1_CACHESAN::WRITE_WITH_OK_DATAActivity::Enabled(){
  OldEnabled=NewEnabled;
  NewEnabled=(((*(RESULT_OK_Mobius_Mark)) >=1)&&((*(WRITE_L1_Mobius_Mark)) >=1));
  return NewEnabled;
}
