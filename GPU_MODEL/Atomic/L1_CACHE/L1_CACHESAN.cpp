...
L1_CACHESAN::L1_CACHESAN(){
  ...
  initializeSANModelNow("L1_CACHE", 11, InitialPlaces, 
                        0, InitialROPlaces, 
  ...
  int AffectArcs[20][2]={ 
    {0,0}, {2,0}, {1,1}, {4,1}, {0,1}, {3,2}, {2,2}, {1,3}, {5,3}, 
    {3,3}, {7,4}, {2,4}, {6,4}, {8,5}, {9,5}, {8,6}, {7,6}, {9,7}, 
    {2,7}, {10,7}
  };
  for(int n=0;n<20;n++) {
...
void L1_CACHESAN::assignPlacesToActivitiesInst(){
  ...
  Instantaneous_Activity12.OK_CONTENT = (Place*) LocalStateVariables[3];
  ...
  WRITE_WITH_OK_DATA.OK_CONTENT = (Place*) LocalStateVariables[3];
