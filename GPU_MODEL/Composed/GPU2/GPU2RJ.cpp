...
char * GPU2RJ__SharedNames[] = {"KO_READ", "MEM_OP_COMPLETE", "OK_READ", "READ_DRAM", "READ_INITIAL_MEMORY", "READ_INTERMEDIATE_MEMORY", "READ_L1", "READ_L2", "RESULT_KO", "RESULT_OK", "WRITE_DRAM", "WRITE_FINAL_MEMORY", "WRITE_INTERMEDIATE_MEMORY", "WRITE_L1", "WRITE_L2"};

GPU2RJ::GPU2RJ():Join("Join", 7, 15,GPU2RJ__SharedNames) {
